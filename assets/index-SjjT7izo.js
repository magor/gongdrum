(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){let e=Array.from(document.querySelectorAll(`[data-gong-player]`));function t(e,t){if(!Number.isFinite(t.duration)||t.duration<=0){e.style.setProperty(`--progress`,`0%`);return}let n=t.currentTime/t.duration*100;e.style.setProperty(`--progress`,`${n}%`)}function n(e){e.style.setProperty(`--progress`,`0%`)}function r(e,n,r){if(!Number.isFinite(n.duration)||n.duration<=0)return;let i=e.getBoundingClientRect();n.currentTime=Math.min(1,Math.max(0,(r-i.left)/i.width))*n.duration,t(e,n)}function i(e,t){let n=e.querySelector(`.gong-player-toggle`);n&&(n.setAttribute(`aria-pressed`,t?`true`:`false`),e.classList.toggle(`is-playing`,t))}function a(t){e.forEach(e=>{if(e===t)return;let n=e.querySelector(`audio`);!n||n.paused||(n.pause(),i(e,!1))})}e.forEach(e=>{let o=e.querySelector(`.gong-player-toggle`),s=e.querySelector(`.gong-player-seek`),c=e.querySelector(`audio`);!o||!s||!c||(o.addEventListener(`click`,async()=>{if(c.paused){a(e);try{await c.play(),i(e,!0)}catch{i(e,!1)}return}c.pause(),i(e,!1)}),s.addEventListener(`click`,e=>{r(s,c,e.clientX)}),s.addEventListener(`pointerdown`,e=>{if(e.button!==0)return;e.preventDefault(),s.setPointerCapture(e.pointerId),r(s,c,e.clientX);let t=t=>{t.pointerId===e.pointerId&&r(s,c,t.clientX)},n=r=>{r.pointerId===e.pointerId&&(s.releasePointerCapture(e.pointerId),s.removeEventListener(`pointermove`,t),s.removeEventListener(`pointerup`,n),s.removeEventListener(`pointercancel`,n))};s.addEventListener(`pointermove`,t),s.addEventListener(`pointerup`,n),s.addEventListener(`pointercancel`,n)}),c.addEventListener(`timeupdate`,()=>t(s,c)),c.addEventListener(`ended`,()=>{n(s),i(e,!1)}),c.addEventListener(`pause`,()=>i(e,!1)))})}function t(e){return`./${e}`}function n(...e){return e.map(t)}var r=new Set([`window-to-the-universe`,`radegast`,`insight`,`lotus-flower`,`sun`,`mandala`,`stand`,`nova-genesis`]),i=[{slug:`window-to-the-universe`,name:`Window to the Universe`,meta:`průměr 1000 mm`,description:`Hluboký základ inspirovaný solfeggio frekvencí stability 174 Hz a zářivé alikvoty pro nové začátky.`,image:t(`obrazky/Window_to_the_Universe/img_5357-2_optimized.jpg`),imageAlt:`GongDrum Window to the Universe`,gallery:n(`obrazky/Window_to_the_Universe/img_5347-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5356-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5357-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5358-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5359-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5360-2_optimized.jpg`,`obrazky/Window_to_the_Universe/img_5362-2_optimized.jpg`),audio:t(`audio/window_to_the_universe.mp3`)},{slug:`radegast`,name:`Radegast`,meta:`průměr 1000 mm`,description:`Temný zvuk hlubokého vesmíru laděný do devíti tónů.`,image:t(`obrazky/Radegast/IMG_3054.JPG`),imageAlt:`GongDrum Radegast`,gallery:n(`obrazky/Radegast/IMG_3060.JPG`,`obrazky/Radegast/IMG_3059.JPG`,`obrazky/Radegast/IMG_3054.JPG`,`obrazky/Radegast/IMG_3052.JPG`,`obrazky/Radegast/IMG_3050.JPG`,`obrazky/Radegast/IMG_3049.JPG`),audio:t(`audio/Radegast.mp3`)},{slug:`little-thai`,name:`Little Thai`,meta:`průměr 480 mm`,description:`Hravý, pozitivní nástroj s jasnou odezvou a přátelským charakterem.`,image:t(`obrazky/Little_Thai/IMG_3982.JPG`),imageAlt:`GongDrum Little Thai`,gallery:n(`obrazky/Little_Thai/IMG_3982.JPG`,`obrazky/Little_Thai/IMG_3974.JPG`,`obrazky/Little_Thai/IMG_3981.JPG`,`obrazky/Little_Thai/IMG_3986.JPG`,`obrazky/Little_Thai/IMG_3992.JPG`,`obrazky/Little_Thai/IMG_3969.JPG`),audio:t(`audio/Little_Thai.mp3`)},{slug:`insight`,name:`Insight`,meta:`průměr 450 mm`,description:`Podmanivě drnčivý zvuk vhodný pro soustředěnou osobní praxi.`,image:t(`obrazky/Insight/IMG_3882.JPG`),imageAlt:`GongDrum Insight`,gallery:n(`obrazky/Insight/IMG_3882.JPG`,`obrazky/Insight/IMG_3883.JPG`,`obrazky/Insight/IMG_3884.JPG`,`obrazky/Insight/IMG_3893.JPG`,`obrazky/Insight/IMG_3894.JPG`,`obrazky/Insight/IMG_3910.JPG`,`obrazky/Insight/IMG_3921.JPG`),audio:t(`audio/Insight.mp3`)},{slug:`lotus-flower`,name:`Lotus Flower`,meta:`průměr 500 mm`,description:`Klidný, meditativní a pročišťující zvuk pro ztišení mysli.`,image:t(`obrazky/Lotus_flower/IMG_4007.JPG`),imageAlt:`GongDrum Lotus Flower`,gallery:n(`obrazky/Lotus_flower/IMG_4007.JPG`,`obrazky/Lotus_flower/IMG_4010.JPG`,`obrazky/Lotus_flower/IMG_4012.JPG`,`obrazky/Lotus_flower/IMG_4014.JPG`,`obrazky/Lotus_flower/IMG_4025.JPG`,`obrazky/Lotus_flower/IMG_4037.JPG`,`obrazky/Lotus_flower/IMG_4043.JPG`),audio:t(`audio/Lotus_flower.mp3`)},{slug:`octopus`,name:`Octopus`,meta:`průměr 800 mm`,description:`Transformační, mocný a hluboký tón F v ladění 432 Hz s bohatými alikvoty.`,image:t(`obrazky/Octopus/IMG_4983.JPG`),imageAlt:`GongDrum Octopus`,gallery:n(`obrazky/Octopus/IMG_4983.JPG`,`obrazky/Octopus/IMG_4986.JPG`,`obrazky/Octopus/IMG_4987.JPG`,`obrazky/Octopus/IMG_4993.JPG`,`obrazky/Octopus/IMG_4996.JPG`,`obrazky/Octopus/IMG_4997.JPG`,`obrazky/Octopus/IMG_4998.JPG`,`obrazky/Octopus/IMG_5006.JPG`),audio:t(`audio/Octopus_long.mp3`)},{slug:`sun`,name:`Sun`,meta:`průměr 700 mm`,description:`Živý a svěží zvuk laděný na G# ve 432 Hz, zaměřený na oblast solar plexu.`,image:t(`obrazky/Sun/IMG_5012.JPG`),imageAlt:`GongDrum Sun`,gallery:n(`obrazky/Sun/IMG_5012.JPG`,`obrazky/Sun/IMG_5014.JPG`,`obrazky/Sun/IMG_5015.JPG`,`obrazky/Sun/IMG_5018.JPG`,`obrazky/Sun/IMG_5019.JPG`,`obrazky/Sun/IMG_5020.JPG`,`obrazky/Sun/IMG_5022.JPG`,`obrazky/Sun/IMG_5024.JPG`),audio:t(`audio/Sun.mp3`)},{slug:`tesla`,name:`Tesla`,meta:`průměr 600 mm`,description:`Jemný, elektrizující zvuk, který otevírá a rozšiřuje prostor.`,image:t(`obrazky/Tesla/IMG_5030.JPG`),imageAlt:`GongDrum Tesla`,gallery:n(`obrazky/Tesla/IMG_5030.JPG`,`obrazky/Tesla/IMG_5031.JPG`,`obrazky/Tesla/IMG_5034.JPG`,`obrazky/Tesla/IMG_5037.JPG`,`obrazky/Tesla/IMG_5047.JPG`,`obrazky/Tesla/IMG_5049.JPG`,`obrazky/Tesla/IMG_5050.JPG`),audio:t(`audio/Tesla.mp3`)},{slug:`mandala`,name:`Mandala`,meta:`rituální gong`,description:`Menší rituální nástroj s jemným, plným a zpřítomňujícím zvukem v ladění 432 Hz.`,image:t(`obrazky/Mandala/img_3939_optimized.jpg`),imageAlt:`GongDrum Mandala`,gallery:n(`obrazky/Mandala/img_3853_optimized.jpg`,`obrazky/Mandala/img_3859_optimized.jpg`,`obrazky/Mandala/img_3867_optimized.jpg`,`obrazky/Mandala/img_3869_optimized.jpg`,`obrazky/Mandala/img_3871_optimized.jpg`,`obrazky/Mandala/img_3936_optimized.jpg`,`obrazky/Mandala/img_3939_optimized.jpg`),audio:t(`audio/Mandala.mp3`)},{slug:`nova-genesis`,name:`Nova Genesis`,meta:`Nova Genesis`,description:`TODO popis`,image:t(`obrazky/Nova_Genesis/DCS_0858.JPG`),imageAlt:`GongDrum Mandala`,gallery:n(`obrazky/Nova_Genesis/DCS_0858.JPG`,`obrazky/Nova_Genesis/DCS_0860.JPG`,`obrazky/Nova_Genesis/DCS_0862.JPG`,`obrazky/Nova_Genesis/DCS_0864.JPG`,`obrazky/Nova_Genesis/DCS_0870.JPG`,`obrazky/Nova_Genesis/DCS_0872.JPG`,`obrazky/Nova_Genesis/DCS_0962.JPG`),audio:t(`audio/Nova_Genesis.mp3`)},{slug:`stand`,name:`Stojan na GongDrum`,meta:`nastavitelná výška`,description:`Teleskopický, rozložitelný a skladný stojan pro pohodlné hraní i transport.`,image:t(`obrazky/Stojan/img_5053_optimized.jpg`),imageAlt:`Stojan na GongDrum`,gallery:n(`obrazky/Stojan/img_5053_optimized.jpg`,`obrazky/Stojan/img_5054_optimized.jpg`,`obrazky/Stojan/img_5055_optimized.jpg`,`obrazky/Stojan/img_5056_optimized.jpg`,`obrazky/Stojan/img_5057_optimized.jpg`)}].map(e=>({...e,sold:r.has(e.slug)})).sort((e,t)=>Number(e.sold)-Number(t.sold));function a(e){return e.audio?`
  ...
  `:``}function o(e){let t=e.gallery.indexOf(e.image),n=t>=0?t:0,r=e.sold?` (Prodáno)`:``,i=e.sold?`Chci podobný kus`:`Mám zájem`;return`
  ...
  `}var p=[`Meditace s GongDrumy: záměr uzdravení, CVČ Jabloňka v Brně-Medlánkách.`,`Nové termíny workshopů budou postupně oznámeny na sociálních sítích.`,`Ve vývoji je GongDrum laděný do devíti solfeggio frekvencí.`];document.querySelector(`#app`).innerHTML=`
