(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){let e=Array.from(document.querySelectorAll(`[data-gong-player]`));function t(e,t){if(!Number.isFinite(t.duration)||t.duration<=0){e.style.setProperty(`--progress`,`0%`);return}let n=t.currentTime/t.duration*100;e.style.setProperty(`--progress`,`${n}%`)}function n(e){e.style.setProperty(`--progress`,`0%`)}function r(e,n,r){if(!Number.isFinite(n.duration)||n.duration<=0)return;let i=e.getBoundingClientRect();n.currentTime=Math.min(1,Math.max(0,(r-i.left)/i.width))*n.duration,t(e,n)}function i(e,t){let n=e.querySelector(`.gong-player-toggle`);n&&(n.setAttribute(`aria-pressed`,t?`true`:`false`),e.classList.toggle(`is-playing`,t))}function a(t){e.forEach(e=>{if(e===t)return;let n=e.querySelector(`audio`);!n||n.paused||(n.pause(),i(e,!1))})}e.forEach(e=>{let o=e.querySelector(`.gong-player-toggle`),s=e.querySelector(`.gong-player-seek`),c=e.querySelector(`audio`);!o||!s||!c||(o.addEventListener(`click`,async()=>{if(c.paused){a(e);try{await c.play(),i(e,!0)}catch{i(e,!1)}return}c.pause(),i(e,!1)}),s.addEventListener(`click`,e=>{r(s,c,e.clientX)}),s.addEventListener(`pointerdown`,e=>{if(e.button!==0)return;e.preventDefault(),s.setPointerCapture(e.pointerId),r(s,c,e.clientX);let t=t=>{t.pointerId===e.pointerId&&r(s,c,t.clientX)},n=r=>{r.pointerId===e.pointerId&&(s.releasePointerCapture(e.pointerId),s.removeEventListener(`pointermove`,t),s.removeEventListener(`pointerup`,n),s.removeEventListener(`pointercancel`,n))};s.addEventListener(`pointermove`,t),s.addEventListener(`pointerup`,n),s.addEventListener(`pointercancel`,n)}),c.addEventListener(`timeupdate`,()=>t(s,c)),c.addEventListener(`ended`,()=>{n(s),i(e,!1)}),c.addEventListener(`pause`,()=>i(e,!1)))})}var t={insight:[`./obrazky/insight/img_3882.JPG`,`./obrazky/insight/img_3883.JPG`,`./obrazky/insight/img_3884.JPG`,`./obrazky/insight/img_3893.JPG`,`./obrazky/insight/img_3894.JPG`,`./obrazky/insight/img_3910.JPG`,`./obrazky/insight/img_3921.JPG`],"little-thai":[`./obrazky/little-thai/IMG_3969.JPG`,`./obrazky/little-thai/IMG_3974.JPG`,`./obrazky/little-thai/IMG_3981.JPG`,`./obrazky/little-thai/IMG_3982.JPG`,`./obrazky/little-thai/IMG_3986.JPG`,`./obrazky/little-thai/IMG_3992.JPG`],"lotus-flower":[`./obrazky/lotus-flower/IMG_4007.JPG`,`./obrazky/lotus-flower/IMG_4010.JPG`,`./obrazky/lotus-flower/IMG_4012.JPG`,`./obrazky/lotus-flower/IMG_4014.JPG`,`./obrazky/lotus-flower/IMG_4025.JPG`,`./obrazky/lotus-flower/IMG_4037.JPG`,`./obrazky/lotus-flower/IMG_4043.JPG`],mandala:[`./obrazky/mandala/img_3853_optimized.jpg`,`./obrazky/mandala/img_3859_optimized.jpg`,`./obrazky/mandala/img_3867_optimized.jpg`,`./obrazky/mandala/img_3
to-the-universe/img_5357-2_optimized.jpg`,`./obrazky/window-to-the-universe/img_5358-2_optimized.jpg`,`./obrazky/window-to-the-universe/img_5359-2_optimized.jpg`,`./obrazky/window-to-the-universe/img_5360-2_optimized.jpg`,`./obrazky/window-to-the-universe/img_5362-2_optimized.jpg`]},n={insight:`./audio/insight.mp3`,"little-thai":`./audio/little-thai.mp3`,"lotus-flower":`./audio/lotus-flower.mp3`,mandala:`./audio/mandala.mp3`,nobody:`./audio/nobody.mp3`,"nova-genesis":`./audio/nova-genesis.mp3`,octopus:`./audio/octopus.mp3`,"om-spiral":`./audio/om-spiral.mp3`,radegast:`./audio/radegast.mp3`,sun:`./audio/sun.mp3`,tesla:`./audio/tesla.mp3`,"window-to-the-universe":`./audio/window-to-the-universe.mp3`},r=new Set([`window-to-the-universe`,`radegast`,`insight`,`lotus-flower`,`sun`,`mandala`,`nova-genesis`,`little-thai`]),i=[{slug:`window-to-the-universe`,name:`Window to the Universe`,meta:`průměr 1000 mm`,description:`Hluboký základ inspirovaný solfeggio frekvencí stability 174 Hz a zářivé alikvoty pro nové začátky.`},{slug:`radegast`,name:`Radegast`,meta:`průměr 1000 mm`,description:`Temný zvuk hlubokého vesmíru laděný do devíti tónů.`},{slug:`little-thai`,name:`Little Thai`,meta:`průměr 480 mm`,description:`Hravý, pozitivní nástroj s jasnou odezvou a přátelským charakterem.`},{slug:`insight`,name:`Insight`,meta:`průměr 450 mm`,description:`Podmanivě drnčivý zvuk vhodný pro soustředěnou osobní praxi.`},{slug:`lotus-flower`,name:`Lotus Flower`,meta:`průměr 500 mm`,description:`Klidný, meditativní a pročišťující zvuk pro ztišení mysli.`},{slug:`octopus`,name:`Octopus`,meta:`průměr 800 mm`,description:`Transformační, mocný a hluboký tón F v ladění 432 Hz s bohatými alikvoty.`},{slug:`sun`,name:`Sun`,meta:`průměr 700 mm`,description:`Živý a svěží zvuk laděný na G# ve 432 Hz, zaměřený na oblast solar plexu.`},{slug:`tesla`,name:`Tesla`,meta:`průměr 600 mm`,description:`Jemný, elektrizující zvuk, který otevírá a rozšiřuje prostor.`},{slug:`mandala`,name:`Mandala`,meta:`rituální gong`,description:`Menší rituální nástroj s jemným, plným a zpřítomňujícím zvukem v ladění 432 Hz.`},{slug:`nova-genesis`,name:`Nova Genesis`,meta:`Nova Genesis`,description:`TODO popis`},{slug:`nobody`,name:`Nobody`,meta:`Nobody`,description:`TODO popis`},{slug:`om-spiral`,name:`Om Spiral`,meta:`Om Spiral`,description:`TODO popis`},{slug:`stand`,name:`Stojan na GongDrum`,meta:`nastavitelná výška`,description:`Teleskopický, rozložitelný a skladný stojan pro pohodlné hraní i transport.`}];function a(e){let i=t[e.slug]??[],a=i[0]??``;return{...e,gallery:i,image:a,imageAlt:`GongDrum ${e.name}`,audio:n[e.slug],sold:r.has(e.slug)}}var o=i.map(a).sort((e,t)=>Number(e.sold)-Number(t.sold));function s(e){return e.audio?`
